...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/Fondness_Updates") ], 
	[InlineKeyboardButton("Subscribe 🧐", url="https://youtube.com/@fondness-editz") ]  ]))
	    return
	if id:
	    if old == True:
	        try:
	...
	**Document Or Video** and enter new filename to rename it__
	""",reply_to_message_id = message.id ,  
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/Fondness_Updatess") ], 
	[InlineKeyboardButton("Subscribe 🧐", url="https://youtube.com/@fondness-editz") ]  ]))
	        except:
	             return
	    else:
